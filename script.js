import { BASE_R2_BUCKET_URL, R2_IMAGES_PATH_SUFFIX_KEY } from './constants.js';
...
const bannerImgUrl = BASE_R2_BUCKET_URL + R2_IMAGES_PATH_SUFFIX_KEY + zeroPad(randomPictureIndex, 3) + ".jpg"
